 ...
 * [ListDrawerFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ListDrawerFragment.newInstance] factory method to
...
//            throw RuntimeException(context.toString() + " must implement OnFragmentInteractionListener")
    ...
    companion object {
         ...
         * @return A new instance of fragment ListDrawerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                ListDrawerFragment().apply {
